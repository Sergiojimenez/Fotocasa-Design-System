module.exports = function (grunt) {
  ...
  var optionDefaults = {
    ...
    css: {
      ...
      fileName: "main",      // the name for our final CSS file that will import everything
      autoprefixer: {
  ...
  function ensureFilesExist(options) {
    ...
    if (!fs.existsSync(coreCssPath)) {
      ...
      fs.writeFileSync(coreCssPath, '@import "_main";');    // TODO: Make this a template based on Sass/LESS - LESS requires the underscore
    }
